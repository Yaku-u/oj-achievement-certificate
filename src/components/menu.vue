    ...
    <div class="menu">
        <div class="menu-header">
            ...
            <div class="menu-button">
                ...
                <div class="download" ref="menuWrapper" @click="showDownloadModal = !showDownloadModal">
                    <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="25px">
                        <path
                    ...
                    <div name="dropdown">
                        <print v-if="showDownloadModal" :certificateRef="certificateRef"></print>
                    </div>
                </div>
...
<script setup>
    ...
    import print from "@/components/download.vue"
